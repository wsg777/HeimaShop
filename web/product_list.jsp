		...
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pageBean.currentPage!=1 }">
				<li>
                    ...
                    <c:if test="${empty cid }">
                        <!-- 搜索页面 -->
                        <a href="${pageContext.request.contextPath}/product?method=searchProducts&parameter=${parameter}&currentPage=${pageBean.currentPage-1 }" aria-label="Next">
                            <span aria-hidden="true">&laquo;</span>
                        </a>
                    </c:if>
				</li>
			...
			<c:forEach begin="1" end="${pageBean.totalPage }" var="page">
				...
				<c:if test="${page!=pageBean.currentPage }">
                    ...
                    <c:if test="${empty cid }">
                        <!-- 搜索页面 -->
                        <li><a href="${pageContext.request.contextPath}/product?method=searchProducts&parameter=${parameter}&currentPage=${page }">${page }</a></li>
                    </c:if>
